...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    useRouteMatch is used like `<Route>` but you can access to its match data automatically.

2. How would you explain form validation to someone who has never programmed before?

    Validation is just there to make sure the user input is valid.

3. In 1-2 sentences, define end to end testing. 

    End to end testing is humanless automatic testing run by a program.
